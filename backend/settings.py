...
SECRET_KEY = 'django-insecure-gq^=%j(^jf0=#ltq36h*bodm*qw^)p8c-&rfdf#1a7ji-(_7*8'
...
CORS_ALLOWED_ORIGINS = [
    ...
    "https://esign-project-oqxqy88lh-abhirups-projects-7f9d618e.vercel.app", 
]
...
REST_FRAMEWORK = {
    ...
    ]#sets Default permission to IsAuthenticated
}
